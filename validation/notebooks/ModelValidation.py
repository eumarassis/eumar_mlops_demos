...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``eumar_mlops_demos/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in eumar_mlops_demos/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in eumar_mlops_demos/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-eumar_mlops_demos-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.eumar_sample.eumar_mlops_demos-model", "Full (Three-Level) Model Name")
