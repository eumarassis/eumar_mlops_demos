...
# ``eumar_mlops_demos/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-eumar_mlops_demos-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.eumar_sample.eumar_mlops_demos-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.eumar_sample.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.eumar_sample.trip_dropoff_features",
